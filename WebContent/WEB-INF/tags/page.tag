...
-->
<%@ attribute name="page" type="com.tust.lamp.orm.Page" rtexprvalue="true" required="true" %>
...
<script type="text/javascript" src="${ctp}/static/jquery/jquery-1.12.3.min.js"></script>
